...
from math import arctan2 as arctan2
from math import arccos as arccos
from math import arcsin as arcsin
...
offset_distance = mat([0.089159,0,0,0.10915,0.09465,0.0823])
link_length = mat([0 ,-0.425 ,-0.39225 ,0 ,0 ,0])
alpha = mat([math.pi/2, 0, 0, math.pi/2, -math.pi/2, 0 ])
